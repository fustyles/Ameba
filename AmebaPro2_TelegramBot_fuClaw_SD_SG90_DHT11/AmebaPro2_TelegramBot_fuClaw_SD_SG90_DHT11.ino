    ...
    if (client) {
      ...
      while (client.connected()) {
        if (client.available()) {
          ...
          if ((currentLine.indexOf("GET / ") != -1) && (currentLine.indexOf(" HTTP") != -1)) {
          ...
          else if ((currentLine.indexOf("GET /chat") != -1) && (currentLine.indexOf(" HTTP/1.1") != -1)) {
            ...
            currentLine = "";
    			...
    			else if ((currentLine.indexOf("GET /message?") != -1) && (currentLine.indexOf(" HTTP/1.1") != -1)) {
...
*/   
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    Serial.println("AI Chat http://" + Ip2String(WiFi.localIP()) + ":81/chat");    
    Serial.println("\n");   
  }  
